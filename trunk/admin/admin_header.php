...
include_once(IMREPORTING_ROOT_PATH . 'include/requirements.php');
...
*/
if (is_object($xoopsModule) && $xoopsModule->dirname() == IMREPORTING_DIRNAME) {
	// We are in the module
	if (defined('XOOPS_CPFUNC_LOADED')) {
		// We are in the admin side of the module
		if (!$xoopsModule->getDBVersion()) {
			redirect_header(ICMS_URL . '/modules/system/admin.php?fct=modulesadmin&op=update&module=' . IMREPORTING_DIRNAME, 4, _AM_IMREPORTING_FIRST_USE);
			exit;
		}
	}
}
